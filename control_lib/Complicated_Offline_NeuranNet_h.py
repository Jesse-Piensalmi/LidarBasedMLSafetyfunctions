...
class SafetyNet():
    def __init__(self, min_d_sample=0.1, iter_mem=50, grid_size_plot=0.1, dh_dt=0.01, smoothing_window = 5):
        ...
        input_dim = 72  # Dimensionality of the state space
        hidden_dim = 64
        output_dim = 4
        self.lstm_hidden_dim = 128
        # Define the neural network
        self.model = SafetyNN(input_dim, hidden_dim, output_dim)
        self.model.load_state_dict(torch.load('/home/jesse/LiDARBasedCBFRobo666/lidar_gp_cbf/safety_nn_model_full_norm_complicated40.pth'))
